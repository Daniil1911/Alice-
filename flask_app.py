...
def rock(res, req):
    ...
    if current_dialog == "rock_genres":
        ...
        if music_genre == 'классика':
            ...
            res['response']['text'] = Session_data[user_id][
                                          'username'] + ', прости, я не знаю такого жанра. Выбери жанр'
            res['response']['buttons'] = get_suggests(user_id)
    return
    ...
    if current_dialog == "mozart_klassika":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = 'Я могу немного рассказать о Моцарте: ' + 'Полное имя — Иога́нн Хризосто́м Во́льфганг Амадéй Мо́царт; 27 января 1756, Зальцбург — 5 декабря 1791, Вена) — австрийский композитор и музыкант-виртуоз. Один из самых популярных классических композиторов, Моцарт оказал большое влияние на мировую музыкальную культуру.)'
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
    ...
    if current_dialog == "raik_pop":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = 'Я могу немного рассказать о rauf & faik: ' + 'Rauf & Faik (Рау́ф и Фáик) — российский музыкальный дуэт, состоящий из братьев-двойняшек Рауфа и Фаика Мирзаевых из Азербайджана (родились 7 июля 1999 году в Ижевске)'
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
    ...
    if current_dialog == "egor_pop":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = 'Я могу немного рассказать о Егоре Криде: ' + 'Егор Николаевич Булаткин (род. 25 июня 1994, Пенза, Россия) более известный под сценическим псевдонимом Егор Крид — российский певец и автор песен. Сольную карьеру начал в 2011 году, с тех пор выпустил два студийных альбома.'
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
    ...
    if current_dialog == "art_pop":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = 'Я могу немного рассказать о Артуре: ' + 'Сейчас Александр Ревва продолжает с успехом развивать персонаж Артура Пирожкова на сцене и телевидении. Актер регулярно публикует фото в полюбившемся образе на странице «Инстаграма».'
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
    ...
    if current_dialog == "lou_rock":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = 'Я могу немного рассказать тебе о этой группе: ' + 'Louna — российская рок-группа с женским вокалом. ' + 'Музыканты: ' + '1. Лусинэ «Лу» Геворкян — вокал ' + '2. Виталий «Вит» Демиденко — бас-гитара, бэк-вокал ' + '3. Рубен «Ру» Казарьян — гитара, бэк-вокал ' + '4. Сергей «Серж» Понкратьев — гитара, бэк-вокал ' + '5. Леонид «Пилот» Кинзбурский — барабаны '
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
    ...
    if current_dialog == "ddt_rock":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = 'Я могу немного рассказать тебе о этой группе: ' + '«ДДТ» (DDT) — советская и российская рок-группа, основанная летом 1980 года в Уфе. Лидер группы, автор большинства песен и единственный бессменный участник — Юрий Шевчук.'
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
    ...
    if current_dialog == "smgl_rock":
        if req['request']['original_utterance'].lower() in ['да', 'конечно', 'ага', 'угу', ]:
            ...
            res['response']['text'] = 'Нет, я честно!'
                                                              ...
                                                              'состав', 'какая', 'концерты']:
            res['response'][
                'text'] = '«Смысловы́е Галлюцина́ции» — советская и российская рок-группа из Екатеринбурга. Первоначально относилась к панк-рок-группам Свердловска, позднее стиль группы стал тяготеть к пост-панку и инди-року.' + 'Музыканты: ' + '1.Сергей Бобунец — вокал, акустика, электрогитара, музыка, текстыал ' + '2.Константин Лекомцев — клавишные, саксофон, гитара, бэк-вокал, аранжировки, музыка, тексты' + '3.Николай Ротов — бас-гитара ' + '4. Максим Митенков — ударные, вокал, тексты ' + '5. Евгений Гантимуров — гитара '
        elif req['request']['original_utterance'].lower() in ['песню', 'песни', 'трек', 'треки', 'музыка', 'музыку', ]:
            res['response']['text'] = 'Я думаю Яндекс Музыка справится лучше меня, открыть Яндекс Музыку?'
        elif req['request']['original_utterance'].lower() in ['открой']:
            res['response']['text'] = 'Ок, открываю Яндекс Музыку..'
